...
void conv_tile_simd(const float* in, float* out, const float* ker, int H, int W, int K);
void conv_tile_simd_unroll(const float* in, float* out, const float* ker, int H, int W, int K);
